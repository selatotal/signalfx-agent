...
Monitor Type: `kubernetes-controller-manager` ([Source](https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/kubernetes/controllermanager))
...
monitors:  # All monitor config goes under this key
 - type: kubernetes-controller-manager
   ...  # Additional config
```
